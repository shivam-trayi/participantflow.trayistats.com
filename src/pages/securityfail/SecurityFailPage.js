        ...
        <div className="bg-red-50/30 text-slate-800 min-h-screen flex items-center justify-center antialiased selection:bg-red-100 selection:text-red-700 sf-cyber-grid relative overflow-hidden px-4 py-8" style={{ fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>
            ...
            <div className="w-full max-w-lg mx-auto text-center flex flex-col items-center relative z-10">
                ...
                <div className="relative mb-14 flex items-center justify-center select-none">
                    ...
                    <div className="absolute w-56 h-56 rounded-full border border-dashed pointer-events-none border-red-300/80">
                    ...
                    <div className="absolute w-44 h-44 rounded-full border pointer-events-none border-red-200">
                    ...
                    <div className="relative w-32 h-32 rounded-3xl backdrop-blur-xl flex items-center justify-center bg-red-50/90 border border-red-400 shadow-[0_16px_40px_-12px_rgba(220,38,38,0.22)] sf-shake-active z-10">
                        ...
                        {/* Padlock Seal Badge */}
                        {!loading && (
                            <div className="absolute -bottom-2 -right-2 bg-gradient-to-tr from-red-600 to-red-500 text-white p-2 rounded-2xl shadow-lg shadow-red-600/30 flex items-center justify-center border-2 border-white scale-100 opacity-100 z-20">
                                <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
                ...
                {/* Live Status Pill */}
                <div className="mb-4 sm:mb-5 inline-flex items-center relative z-20">
                    <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1 sm:py-1.5 rounded-full border shadow-sm bg-red-100 border-red-300 text-red-700 font-bold backdrop-blur-md">
